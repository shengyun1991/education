...
func main() {
	...
	initInfo := &sdkInit.InitInfo{
		...
		ChannelConfig: os.Getenv("GOPATH") + "/src/github.com/itcast.com/education/fixtures/artifacts/channel.tx",

		OrgAdmin:"Admin",
		OrgName:"Org1",
		OrdererOrgName: "orderer.itcast.com",

		ChaincodeID: EduCC,
		ChaincodeGoPath: os.Getenv("GOPATH"),
		ChaincodePath: "github.com/itcast.com/education/chaincode/",
		UserName:"User1",
	}
